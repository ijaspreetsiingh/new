...
?>
	...
	<section id="content">
		...
		<nav>
			...
			<a href="#" class="nav-link"><h1>Add Question</h1></a>
			<form action="#">
		...
		<!-- MAIN -->
		<main>
<marquee style="color:var(--blue);" behavior="" direction="">
	<h1>
		check the Question Number from the table If the value/id is lower then
		<?php echo $next?> then plz incress the value.
	</h1>
</marquee>
